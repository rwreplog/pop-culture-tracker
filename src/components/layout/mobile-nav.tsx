...
export function MobileNav() {
  ...
  return (
    ...
    >
      <div className="bg-background ring-foreground/10 flex w-full max-w-sm items-center justify-around rounded-full py-1.5 shadow-lg ring-1 dark:bg-background/70 dark:shadow-[0_20px_45px_-20px_oklch(0.1_0.04_var(--hue)/0.9)] dark:ring-white/12 dark:supports-[backdrop-filter]:bg-background/60 dark:supports-[backdrop-filter]:backdrop-blur-xl">
